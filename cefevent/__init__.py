...
class CEFEvent(object):
    ...
    _extension_dictionary = {
        ...
        'cn2': {'full_name': 'deviceCustomNumber2', 'data_type': 'Long', 'length': 0, 'description': 'There are three number fields available which can be used to map fields which do not fit into any other field of this dictionary. If possible, "these fields should not be used, but a more specific field from the dictionary. Also check the guidelines hereafter for hints on how to utilize these fields.'},
        ...
        'fd1': {'full_name': 'flexDate1', 'data_type': 'TimeStamp', 'length': 0, 'description': 'A timestamp field available to map a timestamp that does not apply to any other defined timestamp field in this dictionary. Use all flex fields sparingly and seek a more specific, dictionary supplied field when possible. These fields are typically reserved for customer use and should not be set by vendors unless necessary.'},
        'fd1Label': {'full_name': 'flexDate1Label', 'data_type': 'String', 'length': 128, 'description': 'The label field is a string and describes the purpose of the flex field.'},
        'fs1': {'full_name': 'flexString1', 'data_type': 'String', 'length': 1023, 'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary. Use sparingly and seek a more specific, dictionary supplied field when possible. These fields are typically reserved for customer use and should not be set by vendors unless necessary.'},
        'fs1Label': {'full_name': 'flexString1Label', 'data_type': 'String', 'length': 128, 'description': 'The label field is a string and describes the purpose of the flex field.'},
        'fs2': {'full_name': 'flexString2', 'data_type': 'String', 'length': 1023, 'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary. Use sparingly and seek a more specific, dictionary supplied field when possible. These fields are typically reserved for customer use and should not be set by vendors unless necessary.'},
        'fs2Label': {'full_name': 'flexString2Label', 'data_type': 'String', 'length': 128, 'description': 'The label field is a string and describes the purpose of the flex field.'},
