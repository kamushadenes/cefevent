extension_dictionary = {
    ...
    'c6a1Label': {'full_name': 'deviceCustomIPv6Address1Label',
                  'data_type': 'String',
                  'length': 1023,
    ...
    'c6a2': {'full_name': 'deviceCustomIPv6Address2',
             'data_type': 'IPv6 Address',
             'length': 0,
             'description': 'One of four IPV6 address fields available to map fields that do not apply to any other in this dictionary.'},

    'c6a2Label': {'full_name': 'deviceCustomIPv6Address2Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'c6a3': {'full_name': 'deviceCustomIPv6Address3',
             'data_type': 'IPv6 Address',
             'length': 0,
             'description': 'One of four IPV6 address fields available to map fields that do not apply to any other in this dictionary.'},

    'c6a3Label': {'full_name': 'deviceCustomIPv6Address3Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'c6a4': {'full_name': 'deviceCustomIPv6Address4',
             'data_type': 'IPv6 Address',
             'length': 0,
             'description': 'One of four IPV6 address fields available to map fields that do not apply to any other in this dictionary.'},

    'c6a4Label': {'full_name': 'deviceCustomIPv6Address4Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cfp1': {'full_name': 'deviceCustomFloatingPoint1',
    ...
    'cfp1Label': {'full_name': 'deviceCustomFloatingPoint1Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cfp2': {'full_name': 'deviceCustomFloatingPoint2',
             'data_type': 'Floating Point',
             'length': 0,
             'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary.'},

    'cfp2Label': {'full_name': 'deviceCustomFloatingPoint2Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cfp3': {'full_name': 'deviceCustomFloatingPoint3',
             'data_type': 'Floating Point',
             'length': 0,
             'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary.'},

    'cfp3Label': {'full_name': 'deviceCustomFloatingPoint3Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cfp4': {'full_name': 'deviceCustomFloatingPoint4',
             'data_type': 'Floating Point',
             'length': 0,
             'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary.'},

    'cfp4Label': {'full_name': 'deviceCustomFloatingPoint4Label',
                  'data_type': 'String',
                  'length': 1023,
                  'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cat': {'full_name': 'deviceEventCategory',
            'data_type': 'String',
            'length': 1023,
    ...
    'cn1Label': {'full_name': 'deviceCustomNumber1Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cn2': {'full_name': 'deviceCustomNumber2',
            'data_type': 'Long',
            'length': 0,
            'description': 'There are three number fields available which can be used to map fields which do not fit into any other field of this dictionary. If possible, "these fields should not be used, but a more specific field from the dictionary. Also check the guidelines hereafter for hints on how to utilize these fields.'},

    'cn2Label': {'full_name': 'deviceCustomNumber2Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cn3': {'full_name': 'deviceCustomNumber3',
            'data_type': 'Long',
            'length': 0,
            'description': 'There are three number fields available which can be used to map fields which do not fit into any other field of this dictionary. If possible, "these fields should not be used, but a more specific field from the dictionary. Also check the guidelines hereafter for hints on how to utilize these fields.'},

    'cn3Label': {'full_name': 'deviceCustomNumber3Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cnt': {'full_name': 'baseEventCount',
            'data_type': 'Integer',
            'length': 0,
    ...
    'cs1Label': {'full_name': 'deviceCustomString1Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cs2': {'full_name': 'deviceCustomString2',
            'data_type': 'String',
            'length': 1023,
            'description': 'There are six strings available which can be used to map fields which do not fit into any other field of this dictionary. If possible, these fields should not be used, but a more specific field from the dictionary. Also check the guidelines later in this document for hints about utilizing these fields.'},

    'cs2Label': {'full_name': 'deviceCustomString2Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cs3': {'full_name': 'deviceCustomString3',
            'data_type': 'String',
            'length': 1023,
            'description': 'There are six strings available which can be used to map fields which do not fit into any other field of this dictionary. If possible, these fields should not be used, but a more specific field from the dictionary. Also check the guidelines later in this document for hints about utilizing these fields.'},

    'cs3Label': {'full_name': 'deviceCustomString3Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},
    ...
    'cs4Label': {'full_name': 'deviceCustomString4Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cs5': {'full_name': 'deviceCustomString5',
            'data_type': 'String',
            'length': 1023,
            'description': 'There are six strings available which can be used to map fields which do not fit into any other field of this dictionary. If possible, these fields should not be used, but a more specific field from the dictionary. Also check the guidelines later in this document for hints about utilizing these fields.'},

    'cs5Label': {'full_name': 'deviceCustomString5Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'cs6': {'full_name': 'deviceCustomString6',
            'data_type': 'String',
            'length': 1023,
            'description': 'There are six strings available which can be used to map fields which do not fit into any other field of this dictionary. If possible, these fields should not be used, but a more specific field from the dictionary. Also check the guidelines later in this document for hints about utilizing these fields.'},

    'cs6Label': {'full_name': 'deviceCustomString6Label',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'destinationDnsDomain': {'full_name': 'destinationDnsDomain',
                             'data_type': 'String',
                             'length': 255,
                             'description': 'The DNS domain part of the complete fully qualified domain name (FQDN).'},

    'destinationServiceName': {'full_name': 'destinationServiceName',
                               'data_type': 'String',
                               'length': 1023,
                               'description': 'The service which is targeted by this event.'},

    'destinationTranslatedAddress': {'full_name': 'destinationTranslatedAddress',
    ...
    'destinationTranslatedPort': {'full_name': 'destinationTranslatedPort',
                                  'data_type': 'Integer',
                                  'length': 0,
                                  'description': 'Port after it was translated'},

    'deviceCustomDate1': {'full_name': 'deviceCustomDate1',
                          'data_type': 'TimeStamp',
                          'length': 0,
                          'description': 'There are two timestamp fields'},

    'deviceCustomDate1Label': {'full_name': 'deviceCustomDate1Label',
                               'data_type': 'String',
                               'length': 1023,
                               'description': 'All custom fields have a corresponding label field where the field itself can be described. Each of the fields is a string describing the purpose of this field.'},

    'deviceCustomDate2': {'full_name': 'deviceCustomDate2',
                          'data_type': 'TimeStamp',
                          'length': 0,
    ...
    'dhost': {'full_name': 'destinationHostName',
              'data_type': 'String',
              'length': 1023,
    ...
    'dmac': {'full_name': 'destinationMac',
             'data_type': 'MAC Address',
             'length': 0,
             'description': 'Six colon-separated hexadecimal numbers. Example: "00:0D:60:AF:1B:61"'},

    'dntdom': {'full_name': 'destinationNtDomain',
               'data_type': 'String',
               'length': 255,
               'description': 'The Windows domain name of the destination address.'},

    'dpid': {'full_name': 'destinationProcessId',
             'data_type': 'Integer',
             'length': 0,
    ...
    'dpriv': {'full_name': 'destinationUserPrivileges',
              'data_type': 'String',
              'length': 1023,
    ...
    'duid': {'full_name': 'destinationUserId',
             'data_type': 'String',
             'length': 1023,
    ...
    'duser': {'full_name': 'destinationUserName',
              'data_type': 'String',
              'length': 1023,
    ...
    'dvchost': {'full_name': 'deviceHostName',
                'data_type': 'String',
                'length': 100,
    ...
    'externalId': {'full_name': 'externalId',
                   'data_type': 'String',
                   'length': 40,
                   'description': 'An ID used by the originating device.'},

    'fileCreateTime': {'full_name': 'fileCreateTime',
                       'data_type': 'TimeStamp',
                       'length': 0,
                       'description': 'Time when file was created.'},

    'fileHash': {'full_name': 'fileHash',
                 'data_type': 'String',
                 'length': 255, 'description': 'Hash of a file.'},

    'fileId': {'full_name': 'fileId',
               'data_type': 'String',
               'length': 1023,
               'description': 'An ID associated with a file could be the inode.'},

    'fileModificationTime': {'full_name': 'fileModificationTime',
                             'data_type': 'TimeStamp',
                             'length': 0,
                             'description': 'Time when file was last modified.'},

    'filePath': {'full_name': 'filePath',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'Full path to the file, including file name itself.'},

    'filePermission': {'full_name': 'filePermission',
                       'data_type': 'String',
                       'length': 1023,
                       'description': 'Permissions of the file.'},

    'fileType': {'full_name': 'fileType',
                 'data_type': 'String',
                 'length': 1023,
                 'description': 'Type of file (pipe, socket, etc.)'},

    'fd1': {'full_name': 'flexDate1',
            'data_type': 'TimeStamp',
            'length': 0,
    ...
    'fd1Label': {'full_name': 'flexDate1Label',
                 'data_type': 'String',
                 'length': 128,
                 'description': 'The label field is a string and describes the purpose of the flex field.'},

    'fs1': {'full_name': 'flexString1',
            'data_type': 'String',
            'length': 1023,
            'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary. Use sparingly and seek a more specific, dictionary supplied field when possible. These fields are typically reserved for customer use and should not be set by vendors unless necessary.'},

    'fs1Label': {'full_name': 'flexString1Label',
                 'data_type': 'String',
                 'length': 128,
                 'description': 'The label field is a string and describes the purpose of the flex field.'},

    'fs2': {'full_name': 'flexString2',
            'data_type': 'String',
            'length': 1023,
            'description': 'One of four floating point fields available to map fields that do not apply to any other in this dictionary. Use sparingly and seek a more specific, dictionary supplied field when possible. These fields are typically reserved for customer use and should not be set by vendors unless necessary.'},

    'fs2Label': {'full_name': 'flexString2Label',
                 'data_type': 'String',
                 'length': 128,
                 'description': 'The label field is a string and describes the purpose of the flex field.'},

    'fname': {'full_name': 'fileName',
              'data_type': 'String',
              'length': 1023, 'description': 'Name of the file.'},

    'fsize': {'full_name': 'fileSize',
              'data_type': 'Integer',
              'length': 0, 'description': 'Size of the file.'},

    'in': {'full_name': 'bytesIn',
           'data_type': 'Integer',
           'length': 0,
    ...
    'shost': {'full_name': 'sourceHostName',
              'data_type': 'String',
              'length': 1023,
    ...
    'smac': {'full_name': 'sourceMacAddress',
             'data_type': 'MAC Address',
             'length': 0,
             'description': 'Six colon-separated hexadecimal numbers. Example: "00:0D:60:AF:1B:61"'},

    'sntdom': {'full_name': 'sourceNtDomain',
               'data_type': 'String',
               'length': 255,
               'description': 'The Windows domain name for the source address.'},

    'sourceDnsDomain': {'full_name': 'sourceDnsDomain',
                        'data_type': 'String',
                        'length': 255,
                        'description': 'The DNS domain part of the complete fully qualified domain name (FQDN).'},

    'sourceServiceName': {'full_name': 'sourceServiceName',
                          'data_type': 'String',
                          'length': 1023,
                          'description': 'The service which is responsible for generating this event.'},

    'sourceTranslatedAddress': {'full_name': 'sourceTranslatedAddress',
                                'data_type': 'IPv4 Address',
                                'length': 0,
    ...
    'spt': {'full_name': 'sourcePort',
            'data_type': 'Integer',
            'length': 0,
            'description': 'The valid port numbers are 0 to 65535.'},

    'src': {'full_name': 'sourceAddress',
            'data_type': 'IPv4 Address',
            'length': 0,
    ...
    'suser': {'full_name': 'sourceUserName',
              'data_type': 'String',
              'length': 1023,
